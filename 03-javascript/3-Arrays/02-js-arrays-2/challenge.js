...
var ourArray1 = ourArray.push(1)

// push the string "hello" into ourArray
var ourArray2 = ourArray.push("hello")

// push the boolean false into ourArray
var ourArray3 = ourArray.push(bool = false)

// push the number 84 into ourArray
var ourArray4 = ourArray.push(84)

// push the string "world" into our Array
var ourArray5 = ourArray.push("world")
...
var fruitsThatStartWithP = 0;
for (var i = 0; i < fruits.length; i++) {
    if (fruits[i].charAt(0) === "P") {
        fruitsThatStartWithP++
    }
}
console.log(fruitsThatStartWithP)
...
for (i = 0; i < twoDimArray[0].length; i++) {
...
for (i = 0; i < twoDimArray[1].length; i++) {
...
for (i = 0; i < twoDimArray[2].length; i++) {
...
for (i = 0; i < twoDimArray[3].length; i++) {
...
for (i = 0; i < twoDimArray[4].length; i++) {
